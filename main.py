...
def run_experiment_main(path, target_class_index, n_classes, subset, exp, downsample=True):
    ...
    file = open('main-%s%s.txt' % (exp, path.replace('/', '-')), 'a')
...
def run_experiment(path, target_class_index, n_classes, subset, exp, downsample=True):
    ...
    # print(dataset_reader.dataset_size(newdataset, target_class_index))
    class_names = dataset_reader.class_names(dataset, target_class_index)
    file = open('%s%s.txt' % (exp, path.replace('/', '-')), 'a')
...
# class_names = run_experiment('dataset/fasttext/crawl-300d-2M/particular.csv', 0, 2, [2], '3', downsample=True)
# class_names = run_experiment('dataset/fasttext/crawl-300d-2M-subword/particular.csv', 0, 2, [2], '3', downsample=True )
# class_names = run_experiment('dataset/fasttext/wiki-news-300d-1M/particular.csv', 0, 2, [2], '3', downsample=True)
# class_names = run_experiment('dataset/fasttext/wiki-news-300d-1M-subword/particular.csv', 0, 2, [2], '3', downsample=True)
# class_names = run_experiment('dataset/glove/glove6B300d/particular.csv', 0, 2, [2], '3', downsample=True)
# class_names = run_experiment('dataset/glove/glove42B300d/particular.csv', 0, 2, [2], '3', downsample=True)
# class_names = run_experiment('dataset/glove/glove840B300d/particular.csv', 0, 2, [2], '3', downsample=True)
# class_names = run_experiment('dataset/word2vec/particular.csv', 0, 2, [2], '3', downsample=True)
...
# roc_curve.plot_mean('3', [('BNB', y_test_all, bnb),
# ('GNB', y_test_all, gnb),
# ('DT', y_test_all, dt),
# ('RF', y_test_all, rf),
# ('LR', y_test_all, lr),
...
class_names = run_experiment('dataset/fasttext/crawl-300d-2M/particular.csv', 0, 5, [2], '2', downsample=True)
class_names = run_experiment('dataset/fasttext/crawl-300d-2M-subword/particular.csv', 0, 5, [2], '2', downsample=True )
class_names = run_experiment('dataset/fasttext/wiki-news-300d-1M/particular.csv', 0, 5, [2], '2', downsample=True)
class_names = run_experiment('dataset/fasttext/wiki-news-300d-1M-subword/particular.csv', 0, 5, [2], '2', downsample=True)
class_names = run_experiment('dataset/glove/glove6B300d/particular.csv', 0, 5, [2], '2', downsample=True)
class_names = run_experiment('dataset/glove/glove42B300d/particular.csv', 0, 5, [2], '2', downsample=True)
class_names = run_experiment('dataset/glove/glove840B300d/particular.csv', 0, 5, [2], '2', downsample=True)
class_names = run_experiment('dataset/word2vec/particular.csv', 0, 5, [2], '2', downsample=True)


class_names = run_experiment_main('dataset/fasttext/crawl-300d-2M/particular.csv', 0, 5, [2, 3], '2', downsample=True)
class_names = run_experiment_main('dataset/fasttext/crawl-300d-2M-subword/particular.csv', 0, 5, [2, 3], '2', downsample=True )
class_names = run_experiment_main('dataset/fasttext/wiki-news-300d-1M/particular.csv', 0, 5, [2, 3], '2', downsample=True)
class_names = run_experiment_main('dataset/fasttext/wiki-news-300d-1M-subword/particular.csv', 0, 5, [2, 3], '2', downsample=True)
class_names = run_experiment_main('dataset/glove/glove6B300d/particular.csv', 0, 5, [2, 3], '2', downsample=True)
class_names = run_experiment_main('dataset/glove/glove42B300d/particular.csv', 0, 5, [2, 3], '2', downsample=True)
class_names = run_experiment_main('dataset/glove/glove840B300d/particular.csv', 0, 5, [2, 3], '2', downsample=True)
class_names = run_experiment_main('dataset/word2vec/particular.csv', 0, 5, [2, 3], '2', downsample=True)




# class_names = run_experiment('dataset/fasttext/crawl-300d-2M/particular.csv', 1, 30, [2], '1', downsample=True)
# class_names = run_experiment('dataset/fasttext/crawl-300d-2M-subword/particular.csv', 1, 30, [2], '1', downsample=True )
# class_names = run_experiment('dataset/fasttext/wiki-news-300d-1M/particular.csv', 1, 30, [2], '1', downsample=True)
# class_names = run_experiment('dataset/fasttext/wiki-news-300d-1M-subword/particular.csv', 1, 30, [2], '1', downsample=True)
# class_names = run_experiment('dataset/glove/glove6B300d/particular.csv', 1, 30, [2], '1', downsample=True)
# class_names = run_experiment('dataset/glove/glove42B300d/particular.csv', 1, 30, [2], '1', downsample=True)
# class_names = run_experiment('dataset/glove/glove840B300d/particular.csv', 1, 30, [2], '1', downsample=True)
# class_names = run_experiment('dataset/word2vec/particular.csv', 1, 30, [2], '1', downsample=True)
...
# class_names = run_experiment_main('dataset/fasttext/crawl-300d-2M/particular.csv', 1, 30, [2, 3], '1', downsample=True)
# class_names = run_experiment_main('dataset/fasttext/crawl-300d-2M-subword/particular.csv', 1, 30, [2, 3], '1', downsample=True )
# class_names = run_experiment_main('dataset/fasttext/wiki-news-300d-1M/particular.csv', 1, 30, [2, 3], '1', downsample=True)
# class_names = run_experiment_main('dataset/fasttext/wiki-news-300d-1M-subword/particular.csv', 1, 30, [2, 3], '1', downsample=True)
# class_names = run_experiment_main('dataset/glove/glove6B300d/particular.csv', 1, 30, [2, 3], '1', downsample=True)
# class_names = run_experiment_main('dataset/glove/glove42B300d/particular.csv', 1, 30, [2, 3], '1', downsample=True)
# class_names = run_experiment_main('dataset/glove/glove840B300d/particular.csv', 1, 30, [2, 3], '1', downsample=True)
# class_names = run_experiment_main('dataset/word2vec/particular.csv', 1, 30, [2, 3], '1', downsample=True)


# result.save_confusion_matrix_all('1-p2', y_test_all2, main_fnn_rnn, class_names)