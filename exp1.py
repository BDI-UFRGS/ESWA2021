...
def run():
    class_names = run_experiment('fasttext-crawl-300d-2M.csv', 1, 30, [2], '1', downsample=True)
    ...
    class_names = run_experiment_main('fasttext-crawl-300d-2M.csv', 1, 30, [2, 3], '1', downsample=True)
