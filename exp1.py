...
def run():
    ...
    class_names = run_experiment_main('dataset/fasttext/crawl-300d-2M/particular.csv', 1, 30, [2], '1', downsample=True)
    class_names = run_experiment_main('dataset/fasttext/crawl-300d-2M-subword/particular.csv', 1, 30, [2], '1', downsample=True )
    class_names = run_experiment_main('dataset/fasttext/wiki-news-300d-1M/particular.csv', 1, 30, [2], '1', downsample=True)
    class_names = run_experiment_main('dataset/fasttext/wiki-news-300d-1M-subword/particular.csv', 1, 30, [2], '1', downsample=True)
    class_names = run_experiment_main('dataset/glove/glove6B300d/particular.csv', 1, 30, [2], '1', downsample=True)
    class_names = run_experiment_main('dataset/glove/glove42B300d/particular.csv', 1, 30, [2], '1', downsample=True)
    class_names = run_experiment_main('dataset/glove/glove840B300d/particular.csv', 1, 30, [2], '1', downsample=True)
    class_names = run_experiment_main('dataset/word2vec/particular.csv', 1, 30, [2], '1', downsample=True)
